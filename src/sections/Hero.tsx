    ...
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <div className="container">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-8 gap-4">
          <button className="inline-flex items-center rounded-xl gap-2 border border-white/15 px-6 h-12">
            <span className="font-semibold">Explore My Work</span>
            <ArrowDown className="size-4" />
          </button>
          <button className="inline-flex items-center rounded-xl text-gray-900 gap-2 border border-white bg-white px-6 h-12">
            <div>👋</div>
